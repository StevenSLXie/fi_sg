...
Savings rate is simple to state and surprisingly hard to respect.

At its simplest:

`savings rate = annual savings / annual income`

If you earn S$100,000 and save S$30,000, the savings rate is 30 percent. If you earn S$50,000 and save S$25,000, the savings rate is 50 percent.
...
This is the part high earners sometimes miss. If a household earning S$250,000 spends S$200,000, it is not rich in the FI sense. It is a very comfortable machine that needs S$200,000 of annual fuel. If another household earns S$120,000 and spends S$60,000, the second household has less income and a cleaner path.

A high salary is useful. It is not wealth. It is a fast conveyor belt. You can put assets on it, or you can put lifestyle on it.

The conveyor belt does not care.
...
| Starting savings rate | Approximate years to FI |
|---:|---:|
| 10% | 33 |
| 20% | 29 |
| 30% | 24 |
...
At a 72 percent savings rate, the household spends 28 percent of income and saves 72 percent. Put differently, every year of work funds about 2.5 years of current living expenses before investment returns.

`72 / 28 = 2.57`

That is the moment the spreadsheet changes personality.

Chapter 1 said salary is not a perpetuity. The other half of that sentence belongs here: at a high enough savings rate, the portfolio starts to resemble one. One year of work buys more than one year of life. Add investment returns over time, and the curve begins to need you less.
...
## Seventy Is Not The Religion

At this point someone will reasonably object: saving 70 percent is impossible for normal people.
...
A household that says "we save only S$2,000 a month" may be ignoring employee CPF, employer CPF, and mortgage principal. That does not mean the household is secretly rich. It means the measurement is incomplete.

And measurement matters. Moving from 20 percent to 40 percent may remove close to a decade from the FI timeline in a simple model. Moving from 40 to 55 may matter more than finding the perfect ETF. The portfolio gets attention because it has charts. Savings rate deserves attention because it controls how much goes into the portfolio and how much the portfolio must eventually support.

Track it. Improve it. Do not turn it into a personality contest.
...
One caveat before we leave the model.

The savings-rate curve assumes that the surplus is invested in assets that, over the long run, beat inflation. That is a large assumption. It deserves its own chapter.

Inflation can destroy a lazy plan. A withdrawal rate that works in one market period can fail in another. A portfolio that looks safe at age 65 may be too fragile at age 40. The 4 percent rule is useful, but it is not scripture. We will take that seriously later.

But inflation does not change the first-order point. Savings rate determines how much surplus exists to be invested and how much lifestyle must later be funded. Low fixed costs also reduce the surface area exposed to inflation. If your life requires fewer recurring payments, fewer vendors get to reprice your future.

The household still has to invest well enough. But investing starts after the surplus exists.
