...
The first part defines FI, savings rate, bookkeeping, and the withdrawal-rate gauge before the book moves into Singapore-specific institutions.
...
## Part II: The Singapore Stack

The second part explains the local system: CPF, tax, currency, and HDB as mechanisms that shape the FI path.
...
## Part III: The Cost Floor

The third part moves from national systems to household design: housing choices, food, vendors, and children.

| Chapter | Job |
|---|---|
| [9. Why We Left the Condo](manuscript/chapter-09.md) | Prices private housing as a bundle of home, status, leverage, and fixed costs. |
| [10. The First Convenience Tax](manuscript/chapter-10.md) | Turns food into a cost ladder: home cooking, hawker centres, food courts, and restaurants buy different amounts of convenience. |
| [11. The Renaissance Household](manuscript/chapter-11.md) | Shows how practical competence lowers dependence on vendors and keeps convenience from becoming a fixed cost. |
| [12. Children Are Not the FI Killer](manuscript/chapter-12.md) | Separates unavoidable child costs from optional education anxiety and status spending. |

## Part IV: The Investing Machine

The fourth part invests the surplus only after the household has produced it.

| Chapter | Job |
|---|---|
| [13. Investing Is the Easy Part](manuscript/chapter-13.md) | Turns the surplus into a boring, low-cost, automated investment system instead of a heroic stock-picking project. |
| [14. The Index Is Not the Product](manuscript/chapter-14.md) | Separates the index exposure from the fund wrapper that changes tax, estate, liquidity, and administration outcomes. |
...
The fifth part asks whether the plan survives bad years and what work becomes after salary is no longer compulsory.
